...
def test_scipy_optimizer_matches_grid():
...
def test_memory_correlation_high_for_low_d():
...
def test_memory_correlation_low_for_high_d():
...
def test_find_min_d_fallback(monkeypatch):
